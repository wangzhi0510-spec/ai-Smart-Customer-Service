...
async def validation_error_handler(request:Request, exc:RequestValidationError): return JSONResponse(status_code=422, content=error_envelope(AppError("VALIDATION_ERROR","请求参数无效",422,{"errors":exc.errors()}),request_id_for(request)))
